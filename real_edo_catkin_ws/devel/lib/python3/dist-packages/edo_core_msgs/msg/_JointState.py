...
"""autogenerated by genpy from edo_core_msgs/JointState.msg. Do not edit."""
import codecs
import sys
...
class JointState(genpy.Message):
  _md5sum = "fedfea168496dd2f0cbb7b111adbfdfe"
  _type = "edo_core_msgs/JointState"
...
uint16 commandFlag
float32 R_jnt"""
  __slots__ = ['position','velocity','current','commandFlag','R_jnt']
  _slot_types = ['float32','float32','float32','uint16','float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       position,velocity,current,commandFlag,R_jnt
    ...
    if args or kwds:
      ...
      if self.current is None:
        self.current = 0.
      if self.commandFlag is None:
        self.commandFlag = 0
      if self.R_jnt is None:
        self.R_jnt = 0.
    else:
      self.position = 0.
      self.velocity = 0.
